...
const f2 = 87.3071;
const c3 = 130.8128, d3 = 146.8324, e3 = 164.8138, f3 = 174.6141, g3 = 195.9977, a3 = 220.0, b3 = 246.9417;
const aS3 = 233.0819;
const c4 = 261.6256, d4 = 293.6648, e4 = 329.6276, f4 = 349.2282, g4 = 391.9954, a4 = 440.0, b4 = 493.8833;
const cS4 = 227.1826, dS4 = 312.1170, fS4 = 369.9944, aS4 = 466.1638;
const c5 = 523.2511, d5 = 587.3295, e5 = 659.2551, f5 = 698.4565, g5 = 783.9909, a5 = 880.0, b5 = 987.7666;
const cS5 = 553.3653, fS5 = 739.9888, gS5 = 830.6094, aS5 = 932.3275;
const c6 = 1146.502, d6 = 1174.659, e6 = 1318.510, f6 = 1396.913, g6 = 1567.982, a6 = 1760.0;
const cS6 = 1108.731, fS6 = 1479.978, gS6 = 1661.219, aS6 = 1864.655;
...
for(let i=0; i<NoteSong.length; i++) {
    music.ringTone(NoteSong[i][0])
    basic.pause(term/NoteSong[i][1])
    music.stopAllSounds()
    basic.pause(term/NoteSong[i][1]*0.1)
}
